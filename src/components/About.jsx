...
const About = () => (
  <section className="relative pt-16 -mt-8 cont z-10  pb-32">
    ...
    <motion.div className="px-1" variants={AboutF} initial="initial" animate="animate">
    ...
    <motion.div className="absolute bottom-5 -z-10 left-0 w-5/12 md:3/12 lg:w-2/12 h-[150px] about-grad-2 rounded-[30%] rotate-[-20deg] rounded-tr-full rounded-br-full " variants={FadeIn} initial="initial" animate="animate" ></motion.div>
  </section>
);
